...
if(in_array($ekstensi, $ekstensi_diperbolehkan) === true){
	if($ukuran < 2044070){ 
		...
		$query    = mysqli_query($koneksi, "INSERT INTO `upload_ujjian`(`tanggal`, `nama_ujjian`, `file_ujjian`) VALUES ('$tanggal', '$nama_tgs', '$nama')");
		if($query){
			//echo 'FILE BERHASIL DI UPLOAD!';

			echo "<script>alert('FILE BERHASIL DI UPLOAD!');
			window.location.href='index.php?module=BahasaIndonesia';
			</script>";
