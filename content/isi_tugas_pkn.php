...
<div>
	<h2><i class="fa fa-folder-open" aria-hidden="true"></i>Tugas PKN</h2>
	<hr style="border-color: black;">
</div>
...
<div>
    ...
    <table id="example1" class="table table-bordered table-striped">
      ...
      <tbody>
        ...
        $query_tampil = mysqli_query($koneksi,"SELECT * FROM `tb_tugas` WHERE`kategori`='$kategori';");
        ...
        while ($data = mysqli_fetch_array($query_tampil)) {
         ...
         <tr>
          <form action="" method="POST">
            ...
            <td><a href="<?php echo '../Admin/admin/file_tugas/'.$data['soal'];?>" style="color:darkblue;" target="_blank" ><?php echo $data['soal']?></a></td>
...
<div class="container">
  ...
  <form action="tugas_pkn.php" method="POST" enctype="multipart/form-data">
    <div class="form-group">
      <label>Tanggal :</label>
      <input type="date" name="tgl" class="form-control col-4" placeholder="Masukkan Nama" >
    </div>
    <div class="form-group">
      <label>Nama Tugas :</label>
      <input type="text" name="nama_tugas" class="form-control col-4" value="<?= $kategori;?>" readonly>
    </div>
    <div class="form-group">
