...
<div>
	<h2><i class="fa fa-folder-open" aria-hidden="true"></i>Data Ujian Sejarah</h2>
	<hr style="border-color: black;">
</div>
				...
				while ($data = mysqli_fetch_array($query_tampil)) {
					...
					<tr>
						<form action="" method="POST">
							...
							<td><a href="<?php echo '../Admin/sejarah/file_ujian/'.$data['soal'];?>" style="color:darkblue;" target="_blank" ><?php echo $data['soal']?></a></td>
