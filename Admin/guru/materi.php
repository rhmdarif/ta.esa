  ...
  <div class="card-body">
    <table id="example1" class="table table-bordered table-striped">
      ...
      <tbody>
        ...
        <?php
        include 'koneksi.php';
        $query_tampil = mysqli_query($koneksi, "SELECT tb_materi.* FROM tb_materi WHERE tb_materi.id_kelas_mapel IN (SELECT tb_kelas_mapel.id FROM tb_kelas_mapel WHERE tb_kelas_mapel.id_guru='$_SESSION[id_guru]')");
        $no = 1;
